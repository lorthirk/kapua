    ...
    private Widget getUserActionMenu() {
        ...
        userActionButton.addListener(Events.OnMouseOver, new Listener<BaseEvent>() {
            ...
            public void handleEvent(BaseEvent be) {
                ...
                KapuaMenuItem manageTwoFA = new KapuaMenuItem();
                manageTwoFA.setText(CREDENTIAL_MSGS.manageTwoFAMenuItem());
                manageTwoFA.setIcon(IconSet.LOCK);
                manageTwoFA.addSelectionListener(new SelectionListener<MenuEvent>() {

                    @Override
                    public void componentSelected(MenuEvent ce) {
                        TwoFADialog twoFADialog = new TwoFADialog(currentSession, currentSession.getUserId(), currentSession.getUserName());
                        twoFADialog.show();
                    }

                });
                userActionMenu.add(manageTwoFA);
                userActionMenu.add(new SeparatorMenuItem());
