 ...
 */
public class TwoFALoginDialog extends Dialog {
    ...
    public TwoFALoginDialog(LoginDialog loginDialog) {
...
//        setHeading(MSGS.loginTitle());
        ...
        trustCheckbox.setBoxLabel(MSGS.loginDialogTwoFaBoxLabel());
