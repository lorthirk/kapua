...
public class UserTabItemTwoFADescriptor extends AbstractEntityTabDescriptor<GwtUser, UserTabItemTwoFA, UserView> {

    @Override
    public UserTabItemTwoFA getTabViewInstance(UserView view, GwtSession currentSession) {
        return new UserTabItemTwoFA(currentSession);
    }
