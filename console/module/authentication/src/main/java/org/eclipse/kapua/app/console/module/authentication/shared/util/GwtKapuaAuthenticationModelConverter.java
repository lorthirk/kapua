...
public class GwtKapuaAuthenticationModelConverter {
    ...
    private static final MfaAuthenticationService MFA_AUTHENTICATION_SERVICE = LOCATOR.getService(MfaAuthenticationService.class);
    ...
    public static MfaCredentialOptionCreator convertMfaCredentialOptionsCreator(GwtMfaCredentialOptionsCreator gwtMfaCredentialOptionsCreator) {
        ...
        return MFA_CREDENTIAL_OPTION_FACTORY.newCreator(scopeId, userId, "authKey");
    }
