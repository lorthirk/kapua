            ...
            if (selfManagement) {
                scratchCodeListResult = KapuaSecurityUtils.doPrivileged(new Callable<ScratchCodeListResult>() {
                    ...
                    public ScratchCodeListResult call() throws Exception {
                        return SCRATCH_CODE_SERVICE.findByMfaCredentialOptionId(scopeId, mfaCredentialOptionsId);
                    }

                });
            } else {
                scratchCodeListResult = SCRATCH_CODE_SERVICE.findByMfaCredentialOptionId(scopeId, mfaCredentialOptionsId);
            }
