...
public class KapuaGwtAuthenticationModelConverter {
    ...
    public static GwtMfaCredentialOptions convertMfaCredentialOptions(MfaCredentialOption mfaCredentialOptions) {
        ...
        gwtMfaCredentialOptions.setAuthenticationKey(mfaCredentialOptions.getMfaCredentialKey());
